      ...
      <div className="container mx-auto px-6 text-center">
        <div className="animate-fade-in">
          <h1 className="text-6xl md:text-8xl font-light mb-6 tracking-tight antialiased leading-relaxed pb-8">
            ...
            <span className="block bg-gradient-to-r from-[#A0EDE6] via-[#D6B5FF] to-[#FFB2BC] bg-clip-text text-transparent shiny-glass-stroke" style={{ height: '120px', lineHeight: '120px' }}>
              Product Designer
            </span>
          </h1>
