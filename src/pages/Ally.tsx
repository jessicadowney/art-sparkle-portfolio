              ...
              <div className="prose prose-lg max-w-none">
                <div className="bg-accent/30 rounded-lg p-6 mb-8">
                  ...
                  <ul className="space-y-2 text-foreground/80 text-lg">
                    <li>• Led end-to-end UX design for white-labeled router security app at AVG Innovation Group</li>
                    <li>• Created mobile-first setup experience simplifying complex router installation</li>
                    <li>• Designed intuitive security and parental control features for non-technical users</li>
                    <li>• Established design system and information architecture across iOS and Android</li>
                    <li>• Successfully launched as key differentiator for Amped Wireless router product line</li>
                  </ul>
                </div>
